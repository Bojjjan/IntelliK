...
import main.zenit.filesystem.FileController;
import main.zenit.filesystem.metadata.Metadata;
import main.zenit.filesystem.metadata.MetadataVerifier;
import main.zenit.ui.DialogBoxes;
...
public class ProjectMetadataController extends AnchorPane {
	...
	private void changeJREVersion() {
		...
		String JDK = main.zenit.filesystem.jreversions.JREVersions.getFullPathFromName(JDKName);
